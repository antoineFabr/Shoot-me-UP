...
namespace SHOOTMEUP123
{
    public partial class Form1 : Form
    {
        ...
        private void timerCreationBullet_Tick(object sender, EventArgs e)
        {
            ...
            BulletEnemi newbullets = new BulletEnemi(x, 1, BulletEnnemi, this);
            //on affiche la balle 
        ...
        /// <summary>
        /// methode pour savoir quand un ennemi va toucher le joueur
        /// </summary>
        ...
        /// <summary>
        /// bouton si on appuie dessus on ameliore l'attaque de base
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //reduit le cooldown de une seconde chaque amelioration
            cooldownreduit += 1;    
            button1.Enabled = false;
            button1.Visible = false;
            button2.Enabled = false;
        ...
        private void MoveEnnemi_Tick(object sender, EventArgs e)
        {
        ...
        private void CreationVagueEnemi()
        {
            ...
            if (nbrVague == 0)
            {
                VagueEnemi(10);  //le 6 est la vitesse
                nbrVague += 1;
